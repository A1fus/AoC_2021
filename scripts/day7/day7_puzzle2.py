...
point = int(np.floor(data.mean()))
pdf_data = data.to_frame()
pdf_data["distance"] = abs(pdf_data["origin"] - point)
pdf_data["distance_sum"] = pdf_data["distance"].apply(lambda x: sum(range(x + 1)))
print(pdf_data["distance_sum"].sum())
